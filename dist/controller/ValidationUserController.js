...
export async function createValidationCode(userId, code) {
    try {
...
export async function findValidationCode(userId, code) {
    try {
...
export async function validateCode(id) {
    try {
...
export async function deleteValidationCode(id) {
    try {
